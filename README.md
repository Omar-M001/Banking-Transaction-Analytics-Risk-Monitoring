...
![Transaction count and range](Banking_03.png)
...
![Measures Example](Common SQL Expressions .png)
...
### Benchmarking
![Benchmark Snapshot](Benchmarks Evaluations.png)

Ground-truth SQL was manually written for each example question and compared against the SQL generated by Genie to evaluate the accuracy and correctness of the AI responses.
![Ground truth](Ground Truth SQL Q&A.png)
